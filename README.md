...
### 🚀 **Main Portfolio Project: Budget Tracker App**
> A **full-stack personal finance app** deployed on infrastructure **100% managed by code**.

- **Frontend**: React + Vite
- **Backend**: Node.js + Express + PostgreSQL
- **Infrastructure**: AWS + Terraform (VPC, EC2, RDS, S3, Route53)
- **Config Mgmt**: Ansible (server hardening, app deployment)
- **CI/CD**: GitHub Actions (test → build → deploy → notify)
- **Monitoring**: CloudWatch + custom K6 load tests
- **Source**: [https://github.com/gheorghiostapenco/budget-tracker-tf-ansible-gha](https://github.com/gheorghiostapenco/budget-tracker-tf-ansible-gha)

> *All infra, config, and pipelines — defined as code. Zero manual clicks.*
